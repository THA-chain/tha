...
const char * const BITCOIN_CONF_FILENAME = "tha.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\Tha
    // macOS: ~/Library/Application Support/Tha
    // Unix-like: ~/.tha
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Tha";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Tha";
#else
    // Unix-like
    return pathRet / ".tha";
#endif
